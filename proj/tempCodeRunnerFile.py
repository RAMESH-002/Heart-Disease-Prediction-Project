...
# You can add print statements or log messages to indicate the progress
...
# ... [Your earlier imports and code here]
...
# Train individual models, compute metrics, and store them
metrics = {}
for model_name, model in [("decision_tree", decision_tree), ("random_forest", random_forest),
    ...
    # Calculate a simple weight based on accuracy, sensitivity, and specificity
    ...
    # Print metrics for each model on the console
...
# Your routes and other Flask code continue below
...
def get_accuracy():
    ...
    mean_cv_score = perform_cross_validation() * 100  # Convert to percentage
    return render_template('accuracy.html', accuracy=accuracy, mean_cv_score=mean_cv_score)
